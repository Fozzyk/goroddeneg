        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LegalType = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    ...
                    RegAddress = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    OrgName = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    OrgLegalAddress = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    OrgFactAddress = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    OrgDirector = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    IINFrontUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    IINBackUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    RegCertUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LegalDetails", x => x.UserId);
                    table.ForeignKey(
                        name: "FK_LegalDetails_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShortDesc = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    ...
                    PackageType = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    PackagePaid = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryMonth = table.Column<int>(type: "integer", nullable: true),
                    DeliveryYear = table.Column<int>(type: "integer", nullable: true),
                    ShippingType = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "❤️", "Здоровье", "health" },
                    { 5, "🎮", "Игры", "games" },
                    { 6, "📚", "Издание", "publishing" },
                    { 7, "🖼️", "Искусство", "art" },
                    { 8, "₿", "Криптовалюты", "crypto" },
                    { 9, "👗", "Мода", "fashion" },
                    { 10, "🎵", "Музыка", "music" },
                    { 11, "🎓", "Образование", "education" },
                    { 12, "🤝", "Общество", "community" },
                    { 13, "⚽", "Спорт", "sport" },
                    { 14, "🎭", "Театр", "theater" },
                    { 15, "💻", "Технологии", "tech" },
                    { 16, "✈️", "Туризм", "tourism" },
                    { 17, "🎬", "Фильмы и видео", "film" },
                    { 18, "📷", "Фотография", "photo" },
                    { 19, "💃", "Хореография", "dance" }
                });
